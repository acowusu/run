 ...
 */
          ...
          for (d = {}; c < e.length; ) {
            ...
            f =
              ("object" == k && null != p) || "function" == k
                ? "o" +
                  ((Object.prototype.hasOwnProperty.call(p, h) && p[h]) ||
                    (p[h] = ++aa))
                : (typeof p).charAt(0) + p;
  ...
  var V = decodeURI("%73cript"),
    ...
    ua = function () {
      var a = D.nonce;
      return void 0 !== a
        ? a && a === String(a) && a.match(W)
          ? a
          : (D.nonce = null)
        : t.querySelector
        ? (a = t.querySelector("script[nonce]"))
...
gapi.load("", {
  ...
  _c: {
    jsl: {
      ...
      h:
        "m;/_/scs/apps-static/_/js/k\u003doz.gapi.en.TenOR_lLL28.O/am\u003dAQ/d\u003d1/rs\u003dAGLTcCMCcuroc7gdKSyRrVMzYC23sHf_SA/m\u003d__features__",
